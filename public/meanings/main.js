...
$('#violet-state-cta').on('click', function(event) {
    ...
    document.getElementById('violet').innerHTML = "<span style='font-size:20px'> VIOLET <br /><br /> Positive: Spiritual awareness, containment, vision, luxury, authenticity, truth, quality. <br /><br /> Negative: Introversion, decadence, suppression, inferiority. <br /><br /> The shortest wavelength is violet, often described as purple. It takes awareness to a higher level of thought, even into the realms of spiritual values. It is highly introvertive and encourages deep contemplation, or meditation. It has associations with royalty and usually communicates the finest possible quality. Being the last visible wavelength before the ultra-violet ray, it has associations with time and space and the cosmos. Excessive use of purple can bring about too much introspection and the wrong tone of it communicates something cheap and nasty, faster than any other colour.";
});
...
$('#red-state-cta').on('click', function(event) {
    ...
    document.getElementById('red').innerHTML = "<span style='font-size:20px'> RED <br /><br /> Positive: Physical courage, strength, warmth, energy, basic survival, fight or flight, stimulation, masculinity, excitement. <br /><br /> Negative: Defiance, aggression, visual impact, strain. <br /><br /> Being the longest wavelength, red is a powerful colour. Although not technically the most visible, it has the property of appearing to be nearer than it is and therefore it grabs our attention first. Hence its effectiveness in traffic lights the world over. Its effect is physical; it stimulates us and raises the pulse rate, giving the impression that time is passing faster than it is. It relates to the masculine principle and can activate the fight or flight instinct. Red is strong, and very basic. Pure red is the simplest colour, with no subtlety. It is stimulating and lively, very friendly. At the same time, it can be perceived as demanding and aggressive.";
